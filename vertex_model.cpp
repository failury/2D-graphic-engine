...
namespace my_engine
{
    Model::Model(GameEngineDevice &device, const std::vector<Vertex> &vertices): engineDevice{device}
    {
    ...
    void Model::createVertexBuffers(const std::vector<Vertex> &vertices)
    {
        ...
        assert(vertexCount >= 3 && "Vertices count should be at least a triangle");
