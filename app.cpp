...
std::unique_ptr<Model> createSquareModel(GameEngineDevice& device, glm::vec2 offset) {
...
std::unique_ptr<Model> createCircleModel(GameEngineDevice& device, unsigned int numSides) {
...
void app::run() {
  ...
  std::shared_ptr<Model> circleModel = createCircleModel(GameEngineDevice, 64);
